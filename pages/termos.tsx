        ...
        <article className='grid grid-cols-1 gap-12'>
          <section className='flex gap-4 flex-col'>
            ...
            <div className='bg-white rounded-2xl p-4 flex flex-col gap-6'>
              ...
              <p>É importante destacar que não temos como objetivo vender informações de usuários desse serviço ou utilizar esses dados para outro fim a não ser o de enviar mensagens mediante pagamento do usuário.</p>
              <p>Em caso de dúvidas ou solicitações, você pode nos enviar um e-mail pelo endereço khaue.po@hotmail.com.</p>
            </div>
          </section>
        </article>
      </main>
